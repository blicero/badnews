...
# Time-stamp: <2024-10-11 15:31:31 krylon>
#
...
** Clock table
   ...
   #+CAPTION: Clock summary at [2024-10-11 Fr 15:31]
   | Headline                            | Time       |           |       |      |      |
   |-------------------------------------+------------+-----------+-------+------+------|
   | *Total time*                        | *1d 17:18* |           |       |      |      |
   |-------------------------------------+------------+-----------+-------+------+------|
   | *BadNews*                           | *1d 17:18* |           |       |      |      |
   | \_  /Features [1/2]/                |            | /12:44/   |       |      |      |
   | \_    Rating and Tagging [1/2]      |            |           | 12:44 |      |      |
   | \_      Rating [1/1]                |            |           |       | 6:30 |      |
   | \_        Caching results           |            |           |       |      | 0:27 |
   | \_      Tags [0/0]                  |            |           |       | 6:13 |      |
   | \_  /Components [4/4]/              |            | /1d 4:34/ |       |      |      |
