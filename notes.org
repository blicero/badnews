...
# Time-stamp: <2024-10-13 20:15:23 krylon>
#
...
** Clock table
   ...
   #+CAPTION: Clock summary at [2024-10-13 So 20:15]
   | Headline                            | Time      |           |       |       |      |
   |-------------------------------------+-----------+-----------+-------+-------+------|
   | *Total time*                        | *2d 5:43* |           |       |       |      |
   |-------------------------------------+-----------+-----------+-------+-------+------|
   | *BadNews*                           | *2d 5:43* |           |       |       |      |
   | \_  /Features [1/2]/                |           | /22:07/   |       |       |      |
   | \_    Rating and Tagging [1/2]      |           |           | 22:07 |       |      |
   | \_      Rating [1/1]                |           |           |       |  6:30 |      |
   | \_        Caching results           |           |           |       |       | 0:27 |
   | \_      Tags [0/0]                  |           |           |       | 15:36 |      |
   | \_  /Components [4/4]/              |           | /1d 7:36/ |       |       |      |
   | \_    Data model [0/0]              |           |           |  0:27 |       |      |
   | \_    Database [1/1]                |           |           | 11:32 |       |      |
   | \_      Testing [0/0]               |           |           |       |  3:02 |      |
