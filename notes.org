...
# Time-stamp: <2024-10-17 23:30:43 krylon>
#
...
** Clock table
   ...
   #+CAPTION: Clock summary at [2024-10-17 Do 23:30]
   | Headline                                     | Time       |           |         |       |      |
   |----------------------------------------------+------------+-----------+---------+-------+------|
   | *Total time*                                 | *2d 12:56* |           |         |       |      |
   |----------------------------------------------+------------+-----------+---------+-------+------|
   | *BadNews*                                    | *2d 12:56* |           |         |       |      |
   | \_  /Features [2/5]/                         |            | /1d 4:35/ |         |       |      |
   | \_    Rating and Tagging [2/5]               |            |           | 1d 4:35 |       |      |
   | \_      Rating [1/1]                         |            |           |         |  6:30 |      |
   | \_        Caching results                    |            |           |         |       | 0:27 |
   | \_      Tags [1/3]                           |            |           |         | 22:04 |      |
   | \_        Add newly created tags to tag_view |            |           |         |       | 1:20 |
   | \_        Link Tags to Items [0/0]           |            |           |         |       | 3:33 |
