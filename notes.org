...
# Time-stamp: <2024-10-18 23:19:16 krylon>
#
...
** Clock table
   ...
   #+CAPTION: Clock summary at [2024-10-18 Fr 23:19]
   | Headline                                     | Time       |           |         |         |      |
   |----------------------------------------------+------------+-----------+---------+---------+------|
   | *Total time*                                 | *2d 17:57* |           |         |         |      |
   |----------------------------------------------+------------+-----------+---------+---------+------|
   | *BadNews*                                    | *2d 17:57* |           |         |         |      |
   | \_  /Features [2/5]/                         |            | /1d 9:36/ |         |         |      |
   | \_    Rating and Tagging [2/5]               |            |           | 1d 9:36 |         |      |
   | \_      Rating [1/1]                         |            |           |         |    6:30 |      |
   | \_        Caching results                    |            |           |         |         | 0:27 |
   | \_      Tags [1/3]                           |            |           |         | 1d 3:05 |      |
   | \_        Add newly created tags to tag_view |            |           |         |         | 1:20 |
   | \_        Link Tags to Items [0/0]           |            |           |         |         | 8:34 |
