...
# Time-stamp: <2024-10-12 21:01:13 krylon>
#
...
** Clock table
   ...
   #+CAPTION: Clock summary at [2024-10-12 Sa 21:01]
   | Headline                            | Time      |           |       |       |      |
   |-------------------------------------+-----------+-----------+-------+-------+------|
   | *Total time*                        | *2d 0:08* |           |       |       |      |
   |-------------------------------------+-----------+-----------+-------+-------+------|
   | *BadNews*                           | *2d 0:08* |           |       |       |      |
   | \_  /Features [1/2]/                |           | /16:43/   |       |       |      |
   | \_    Rating and Tagging [1/2]      |           |           | 16:43 |       |      |
   | \_      Rating [1/1]                |           |           |       |  6:30 |      |
   | \_        Caching results           |           |           |       |       | 0:27 |
   | \_      Tags [0/0]                  |           |           |       | 10:12 |      |
   | \_  /Components [4/4]/              |           | /1d 7:25/ |       |       |      |
   | \_    Data model [0/0]              |           |           |  0:27 |       |      |
   | \_    Database [1/1]                |           |           | 11:21 |       |      |
   | \_      Testing [0/0]               |           |           |       |  2:51 |      |
